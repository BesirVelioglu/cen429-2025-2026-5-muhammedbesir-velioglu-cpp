...
call reportgenerator "-title:LocalSports Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:LocalSports Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for LocalSports
call OpenCppCoverage.exe --export_type=binary:LocalSports_tests_unit_win.cov --sources src\LocalSports\src --sources src\LocalSports\header --sources src\tests\LocalSports -- build_win\build\Debug\LocalSports_tests.exe

echo Generate Test Coverage Data for LocalSports App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=LocalSports_tests_unit_win.cov --export_type=cobertura:LocalSportsapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\LocalSports\src --sources src\LocalSports\header --sources src\LocalSportsapp\src --sources src\LocalSportsapp\header --sources src\tests\utility --sources src\tests\LocalSports -- build_win\build\Debug\LocalSportsapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:LocalSports Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/LocalSportsapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/LocalSports/src;src/LocalSports/header;src/LocalSportsapp/src;src/LocalSportsapp/header;src/tests/utility;src/tests/LocalSports" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/LocalSportsapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/LocalSports/src;src/LocalSports/header;src/LocalSportsapp/src;src/LocalSportsapp/header;src/tests/utility;src/tests/LocalSports" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\LocalSports\header "build_win\build\Release" /E
call robocopy src\LocalSportsapp\header "build_win\build\Release" /E
...
call robocopy src\LocalSports\header "build_win\build\Debug" /E
call robocopy src\LocalSportsapp\header "build_win\build\Debug" /E
